            ...
            <el-form :model="editFrom" :rules="editFromRules" ref="editFrom" label-width="100px" class="demo-editFrom">
                ...
                <el-form-item label="菜单名称" prop="name" label-width="100px">
                 ...
                 <el-form-item label="权限编码" prop="perms" label-width="100px">
                    <el-input v-model="editFrom.perms" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="图标" prop="icon" label-width="100px">
                    <el-input v-model="editFrom.icon" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="菜单URL" prop="path" label-width="100px">
                    <el-input v-model="editFrom.path" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="菜单组件" prop="component" label-width="100px">
                    <el-input v-model="editFrom.component" autocomplete="off"></el-input>
                </el-form-item>
                ...
                <el-form-item label="状态" prop="status" label-width="100px">
                 ...
                 <el-form-item label="排序号" prop="orderNum" label-width="100px">
                    <el-input-number v-model="editFrom.orderNum" :min="1" autocomplete="off" label="排序号"></el-input-number>
                </el-form-item>
                <el-form-item>
        ...
        methods: {
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        this.$axios.post('/sys/menu/' + (this.editFrom.id ? 'update' : 'save'), this.editFrom).
                        then (res => {
                            this.$message({
                                showClose: true,
                                message: '恭喜你，操作成功！',
            ...
            editHandle(id) {
                this.$axios.get('/sys/menu/detail?menuId=' + id).then(res => {
            ...
            delHandle(id, lockVersion) {
                this.$axios.delete("/sys/menu/delete", {
                        data: {
                            id: id,
